...
export const blogPosts = [
  {
    ...
    content: [
      "The rise of artificial intelligence has ushered in an era of unprecedented technological advancement...",
      "One of the most fascinating and potentially transformative areas within AI is simulated behavior...",
      // ... more content
    ],
  ...
  },
  {
    ...
    content: [
      "Branding is more than just a logo; it's the entire perception your audience has of your business...",
      "A well-defined brand strategy can set you apart from the competition...",
      // ... more content
    ],
