...
const PaginationControls = ({ page, totalPages, onPageChange, isFetching, pageRangeDisplayed = 1, className = '' }) => {
  if (totalPages <= 1) return null;

  const pageItems = getPaginationItems(page, totalPages, pageRangeDisplayed);

  return (
    <div className={`flex items-center justify-center gap-2 mt-8 md:gap-3 ${className}`} aria-label="Pagination Navigation">
      {/* Previous Button */}
      <button
